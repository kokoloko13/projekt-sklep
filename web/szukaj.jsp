...
<head>
    ...
    <!-- Title -->
    <title>Sklep komputerowy Kompix | Wyszukiwanie | ${param['q']}</title>
</head>
<body>
<div class="container">
    <!-- Navbar -->
    ...
    <div class="steals">
        <div class="breaker">
            <div class="breaker_title"><h2>Wyniki wyszukiwania "${param['q']}"</h2></div>
        ...
        <div class="products">
            ...
            <sql:query dataSource="${db}" var="search">
                SELECT * from products WHERE product_name LIKE '%${param["q"]}%';
            </sql:query>

            <c:forEach var="product" items="${search.rows}">
                <div class="product">
            ...
            <c:if test="${fn:length(search.rows) == 0}">
                <h2 style="text-align: center;">Brak wyników wyszukiwania.</h2>
            </c:if>
